...
class TestRunnerLifecycle:
    ...
    def test_first_ticker_builds_grid(self, strategy_config, executor):
    ...
    def test_inject_open_orders_adopts_exchange_orders(self, strategy_config, executor):
    ...
    def test_order_update_tracks_status(self, strategy_config, executor):
    ...
    def test_consecutive_tickers_stable(self, strategy_config, executor):
    ...
    def test_shadow_mode_no_real_api_calls(self, strategy_config, executor):
    ...
    def test_fill_updates_tracked_order(self, strategy_config, executor):
        ...
        runner.on_execution(exec_event)

        assert tracked.status == "filled"

    def test_position_update_adjusts_multipliers(self, strategy_config, executor):
    ...
    def test_same_order_detection_blocks_execution(self, strategy_config, executor):
