...
7. **orderLinkId Wire Format & Matching (HOTFIX 2026-05-08)**: How the deterministic `client_order_id` survives Bybit's id-cache
   ...
   - **Files**: `packages/gridcore/src/gridcore/intents.py` (helper), `apps/gridbot/src/gridbot/executor.py` (suffix appended at place_order), `apps/gridbot/src/gridbot/runner.py` (read-side normalization), `apps/comparator/src/comparator/loader.py`, `apps/replay/src/replay/snapshot_loader.py`.
